        ...
        <form id="upload-form" @submit.prevent class="form">
          <div class="form-group">
            ...
            <input
              ...
              ref="fileInput"
              type="file"
              accept=".csv, .zip, .xls, .xlsx, text/csv, .sav, application/zip,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel"
              @change="importFile"/>
            <div class="supported-types">
              <span class="text-muted"><em>{{ 'file-types' | i18n }}: XLSX, XLS, CSV, SAV</em></span>
            </div>
          </div>
        </form>
      </div>
